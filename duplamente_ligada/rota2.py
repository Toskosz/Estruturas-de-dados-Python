from duplamente_ligada.lista_duplamente_ligada import ListaDuplamenteLigada, Celula
...
def main():
    ...
    loja7 = Loja("Minimercado das Frutas", "Rua do Pomar, 600")
    loja8 = Loja("Supermercado das Frutas", "Av do Bosque, 66")
